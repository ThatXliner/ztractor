...
- **Global scope**: `/Users/bryanhu/Developer/Pending/ztractor/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/bryanhu/Developer/Pending/ztractor/.claude/notes/`)
...
2. Glob `/Users/bryanhu/Developer/Pending/ztractor/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/bryanhu/Developer/Pending/ztractor/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/bryanhu/Developer/Pending/ztractor/.claude/notes/` — works in any directory
