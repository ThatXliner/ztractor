...
- Usage: Reference from command with `@/Users/bryanhu/Developer/Pending/ztractor/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/bryanhu/Developer/Pending/ztractor/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/bryanhu/Developer/Pending/ztractor/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
